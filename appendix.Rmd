...
library(forcats)
paymentMode<-fct_collapse(paymentMode, "-1" = c("-1"), "-2" = c("-2"), "0" = c("0"), "Overdue" = c("1","2","3","4","5","6","7","8","9")) #Simplify the factorisation of mode
...
arm::binnedplot(predict(finalModel),rstandard(finalModel,type="pearson"),nclass=60,col.int=NA, main ="Binned Standardised Pearson Residuals") # standardised pearson residual and 60 bins
arm::binnedplot(predict(finalModel),rstandard(finalModel,type="deviance"),nclass=40,col.int=NA, main ="Binned Standardised Deviance Residuals") # standardised deviance residual and 40 bins
